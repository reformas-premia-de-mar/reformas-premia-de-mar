...
//Your E-mail
$your_email = 'info@barcelonareformas.pro';

//Default Subject if 'subject' field not specified
$default_subject = 'De mi formulario de contacto';

//Message if 'name' field not specified
$name_not_specified = 'Escribe un nombre valido';

//Message if e-mail sent successfully
$email_was_sent = 'Su mensaje se ha enviado con exito. Muchas gracias.';

//Message if e-mail not sent (server not configured)
$server_not_configured = 'Lo sentimos, el servidor de correo no esta configurado (la funcion "mail ()" esta deshabilitada en su servidor?)';
...
//	$from = (!empty($sender_email)) ? 'From: '.$sender_email : '';
	$from = "From: bot@barcelonareformas.pro";
